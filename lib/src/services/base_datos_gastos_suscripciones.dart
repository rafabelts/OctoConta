...
class BaseDatosDeGastosSuscripciones {
  // Referencia la box
  final _mybox = Hive.box("base_datos_suscripciones");

  // escribir datos gasto
  void guardarGastosSuscripciones(List<GastoItem> gastos) {
