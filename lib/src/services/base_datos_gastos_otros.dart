...
class BaseDatosDeGastosOtros {
  // Referencia la box
  final _mybox = Hive.box("base_datos_otros");

  // escribir datos gasto
  void guardarGastosOtros(List<GastoItem> gastos) {
