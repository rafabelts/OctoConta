...
class BaseDatosDeGastosServicios {
  // Referencia la box
  final _mybox = Hive.box("base_datos_servicios");

  // escribir datos gasto
  void guardarGastosServicios(List<GastoItem> gastos) {
