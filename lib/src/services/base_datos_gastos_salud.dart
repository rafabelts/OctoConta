...
class BaseDatosDeGastosSalud {
  // Referencia la box
  final _mybox = Hive.box("base_datos_salud");

  // escribir datos gasto
  void guardarGastosSalud(List<GastoItem> gastos) {
