...
class VerificacionDeCorreo extends StatefulWidget {
  ...
  @override
  State<VerificacionDeCorreo> createState() => _VerificacionDeCorreoState();
}

class _VerificacionDeCorreoState extends State<VerificacionDeCorreo> {
